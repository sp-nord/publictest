...
EOPHP
	...
	# THERE WAS DATABASE CREATION PROCESS FOR MYSQL RIGHT HERE
	# REMOVED SINCE WE HAVE POSTGRES
	# NOT REPLACED SINCE WE CREATE DB DURING POSTGRES CONTAINER STARTUP
	# COULD BE REPLACED IF PROVIDED SU CREDS FOR POSTGRES
	fi
